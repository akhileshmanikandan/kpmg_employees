                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      ...
                      showDialog(context: context, builder: (context){
                        return CustomDialogBox(title: "Congrats!", descriptions: "Your account has been created\n\nKindly go back to the login page to continue", text: "Okay", img: Image.asset("assets/tick_mark.png"),
                          );
